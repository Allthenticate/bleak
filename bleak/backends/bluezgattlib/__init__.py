...
class GattlibAdvertisementData(Structure):
    _fields_ = [("uuid", GattlibUuid), ("data", c_void_p), ("data_length", c_size_t)]
...
#        void *user_data);
gattlib_discovered_device_with_data_type = CFUNCTYPE(
    None,
    c_void_p,
    c_char_p,
    c_char_p,
    POINTER(GattlibAdvertisementData),
    c_size_t,
    c_uint16,
    c_void_p,
    c_size_t,
...
gattlib_adapter_scan_disable_async.argtypes = [c_void_p]
...
gattlib_adapter_scan_eddystone.argtypes = [
    c_void_p,
    c_int16,
    c_uint32,
    gattlib_discovered_device_with_data_type,
    c_size_t,
    py_object,
]
...
gattlib_get_advertisement_data.argtypes = [
    c_void_p,
    POINTER(POINTER(GattlibAdvertisementData)),
    POINTER(c_size_t),
    POINTER(c_uint16),
    POINTER(c_void_p),
    POINTER(c_size_t),
